...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pycoingecko-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14045&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pycoingecko-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pycoingecko` can be installed with:

```
conda install pycoingecko
```

It is possible to list all of the versions of `pycoingecko` available on your platform with:
