...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pycoingecko-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pycoingecko-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pycoingecko
# for installing globally
pixi global install pycoingecko
```
...
It is possible to list all of the versions of `pycoingecko` available on your platform:
...
```
pixi search pycoingecko --channel conda-forge
```
